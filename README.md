...
# ☕ The Coffee Shop Data Project  
### From Beans to Business Insights Ever wondered what makes a coffee shop thrive? This project dives deep into sales data to uncover the secrets behind successful coffee sales—all using the power of Microsoft Excel.
...
| Chart | Insight |
|-------|---------|
| 📦 **Quantity Coffee Per Category** | See which coffee categories sell the most units |
...
#### ☕ **Customer Preferences by Time of Day**
- 🌅 **Morning Favorite**: **Americano with Milk** takes the lead during morning hours
- ☀️ **Afternoon Go-To**: **Latte** is the top choice for afternoon customers
- 🌙 **Evening Choice**: **Latte** remains popular for night sales

#### 🏆 **Best Performing Coffees By Category**
- **Americano with Milk** and **Latte** are the star performers across categories
